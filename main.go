...
func run(ctx context.Context, args []string, stdout, stderr io.Writer) int {
	...
	flags.Usage = func() {
		...
		fmt.Fprintln(stderr, "Encrypted/unreadable definitions or CLR/extended modules cause an error; they are never silently skipped.")
		...
		fmt.Fprintln(stderr, "Does not compare rows, defaults, identity, computed expressions, collation, non-PK indexes,")
		fmt.Fprintln(stderr, "FK/CHECK/UNIQUE constraints, triggers, permissions, or type/XML schema definitions.")
